...
/* harmony export */   filterForStatus: () => (/* binding */ filterForStatus),
...
function filterForUrgency(visits) {
    visitUrgency.addEventListener('change', function (e) {
        ...
        urgencyOption = value;
        applyFilters(visits,_index_js__WEBPACK_IMPORTED_MODULE_0__.displayCards);
    });
}
...
async function displayCards(filteredVisits) {
    ...
    try {
        ...
        if (!data || data.length === 0) {
            ...
            ;(0,_filter_js__WEBPACK_IMPORTED_MODULE_3__.filterForStatus)(visits)
...
function createVisit() {
    // if (!createVisitModal) {
        ...
        createVisitModal = new _modal_js__WEBPACK_IMPORTED_MODULE_0__["default"]('Create Visit');
        ...
        createButton.addEventListener('click', async () => {
            ...
            const filteredVisits=(0,_filter_js__WEBPACK_IMPORTED_MODULE_3__.applyFilters)(visits,displayCards)
...
const sendCards = async (obj, selectedOption, createVisitModal) => {
    try {
        ...
        if (response.ok) {
            ...
            const newVisit = new _visit_js__WEBPACK_IMPORTED_MODULE_1__["default"](fullName, selectedOption, createdVisit.id, details)
            const data = await fetchCards();
