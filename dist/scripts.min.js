    ...
    try {
        ...
        if (!data || data.length === 0) {
            ...
            const visits = data.map((visit) => {
                console.log(visit)
                const newVisit = new _visit_js__WEBPACK_IMPORTED_MODULE_1__["default"](visit.fullName, visit.doctor, visit.id, visit.description);
                return newVisit
            })
...
const sendCards = async (obj, selectedOption, createVisitModal) => {
    try {
        ...
        if (response.ok) {
            ...
            const newVisit = new _visit_js__WEBPACK_IMPORTED_MODULE_1__["default"](fullName, selectedOption, response_1.id, description)
            newVisit.render();
